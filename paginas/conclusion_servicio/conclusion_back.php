...
public function obtenerRegistros()
{
  ...
  $query_registros="SELECT * FROM conclusion_servicio LIMIT 10";
...
public function obtenerElemento($no_control)
  ...
  public function agregarRegistro($id, $tipoco, $tipoba, $motivo, $instancia, $fechaconc)
  {
    require '../../requires/conexion.php';
    $query_registrocap="INSERT INTO conclusion_servicio (cuip, tipo_conclucion, tipo_baja, motivo, intancia, fecha_conclusion)
    VALUES
    ('$id', '$tipoco', '$tipoba', '$motivo', '$instancia', '$fechaconc')";
  ...
  public function buscarRegistro($control)
  {
    ...
    require '../../requires/conexion.php';
    if ($control != "") {
      $query_registro="SELECT * FROM conclusion_servicio WHERE cuip ='$control'";
    }elseif ($control == "") {
      $query_registro="SELECT * FROM conclusion_servicio LIMIT 10";
    }
...
*/
if (isset($_POST["id"]) && isset($_POST["tipoco"])&& isset($_POST["tipoba"])&& isset($_POST["motivo"])&& isset($_POST["instancia"])&& isset($_POST["fechaconc"]))
{
  $capacitacion->agregarRegistro($_POST["id"],$_POST["tipoco"],$_POST["tipoba"],$_POST["motivo"],$_POST["instancia"],$_POST["fechaconc"]);
  /*
  echo
  $_POST["id"]."---".
  $_POST["tipoco"]."---".

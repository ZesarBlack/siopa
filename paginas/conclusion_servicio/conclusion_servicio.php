                            ...
                            <div class="x_content" style="overflow:auto; overflow:scroll; height: 50em">
                                ...
                                <table class="table table-striped jambo_table table-bordered">
                                  <thead>
                                    ...
                                    <th>Tipo de baja</th>
                                    <th>Motivo de conclusión</th>
                                    <th>Intancia ordenadora</th>
                                    <th>Fecha de conclusión del servicio</th>
                                  </thead>
                                      ...
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          ...
                                          <div class="modal-body">
                                                  ...
                                                  <div class="row" style="margin-top:2em;">
                                                      <div class="col-sm-1"></div>
                                                      <div class="col-sm-3">Tipo de conclusión</div>
                                                      <div class="col-sm-7">
                                                        <input type="text" onkeyup="mayus(this)" style='font-size: 12pt;
                                                        font-weight: bold; color: red; text-align: center;' class="form form-control" name="tipoco" id="tipoco" value="">
                                                      </div>
                                                  </div>
                                                  <div class="row" style="margin-top:2em;">
                                                      <div class="col-sm-1"></div>
                                                      <div class="col-sm-3">Tipo de baja</div>
                                                      <div class="col-sm-7">
                                                        <input type="text" onkeyup="mayus(this)" style='font-size: 12pt;
                                                        font-weight: bold; color: red; text-align: center;' class="form form-control" name="tipoba" id="tipoba" value="">
                                                      </div>
                                                  </div>
                                                  <div class="row" style="margin-top:2em;">
                                                      <div class="col-sm-1"></div>
                                                      <div class="col-sm-3">Motivo de la conclusión</div>
                                                      <div class="col-sm-7">
                                                  ...
                                                  <div class="row" style="margin-top:2em;">
                                                      <div class="col-sm-1"></div>
                                                      <div class="col-sm-3">Instancia ordenadora</div>
                                                      <div class="col-sm-7">
                                                  ...
                                                  <div class="row" style="margin-top:2em;">
                                                      <div class="col-sm-1"></div>
                                                      <div class="col-sm-3">Fecha de conclusión del servicio</div>
                                                      <div class="col-sm-7">
                                                            <input id="fechaconc" class="form form-control" onkeyup="mayus(this)" value="" name="fechaconc" type="date" style='font-size: 12pt;
                                                            font-weight: bold; color: red; text-align: center;' maxlength="20" required>
                                                      </div>
                                                  </div>
...
<script type="text/javascript" src="conclusion.js"></script></script>

...
<html lang="en">
  ...
  require 'competencias_back.php';
  $competencias->excelCompetencias("");
  ?>
  <body class="nav-md">
                          ...
                          <div class="col-md-2">
                            ...
                            <div class="x_content" style="overflow:auto; overflow:scroll; height: 50em">
                                ...
                                <table class="table table-striped jambo_table table-bordered">
                                  ...
                                  <tbody id="lista">
                                    <?php $competencias->obtenerRegistros(); ?>
                                  </tbody>
                                </table>
                                <!-- content ends here////////////////////// -->
                                        ...
                                        <div class="modal-header">
                                          ...
                                          <div class="modal-body">
                                                  ...
                                                  <div class="row" style="margin-top:2em;">
                                                      ...
                                                      <div class="col-sm-7">
                                                          <input id="control" class="form form-control" value="" name="control" type="texts" style='font-size: 12pt;
                                                  ...
                                                  <div class="modal-footer">
                                                      <button type="button" onclick="agregarRegistrocom()" class="btn btn-primary">Registrar</button>
                                                  </div>
                                          </div>
                                          <!-- Modal footer -->
                                      </div>
...
<script type="text/javascript" src="competencias.js">
